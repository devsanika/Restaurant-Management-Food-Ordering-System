  ...
  <div class="cart-details ">
    ...
    <div class="order-summary">
      ...
      <div class="summary-details payment">
        ...
        <div>
          <input type="radio" id="cash" name="payment_mode" value="Dine-in">
          <label for="Cash">Dine In</label>
        </div>
        <div>
          <input type="radio" id="card" name="payment_mode" value="Card" disabled style="cursor: not-allowed;">
          <label for="Card">Home Delivery</label>
        </div>
      </div>
      <div class="summary-details">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateDeliveryFee() {
        ...
        deliveryFee = selectedPaymentMode === 'Takeaway' ? 0 : 75;
        updateSummary();
      }
